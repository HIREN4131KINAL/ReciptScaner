 ...
 * use the {@link #generate(co.smartreceipts.android.model.Trip)} method to build a report.
 */
public interface Report {
     ...
     * </p>
     *
     * @param trip the parent {@link co.smartreceipts.android.model.Trip} to generate
