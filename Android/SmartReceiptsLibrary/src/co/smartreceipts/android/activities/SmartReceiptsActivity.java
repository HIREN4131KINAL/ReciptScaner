...
public class SmartReceiptsActivity extends WBActivity implements Navigable, Attachable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mActionBarController = new ActionBarController(this, getSupportActionBar(), getResources().getStringArray(R.array.actionbar_subtitles));
		...
		if (savedInstanceState == null) {
			...
			AppRating.initialize(this)
					 .setMinimumLaunchesUntilPrompt(LAUNCHES_UNTIL_PROMPT)
					 .setMinimumDaysUntilPrompt(DAYS_UNTIL_PROMPT)
					 .hideIfAppCrashed(true)
	...
	public void onPanelOpened(View panel) { //onTripsBeingViewed
		...
		if (!mIsDualPane) {
			...
			setTitle(getSmartReceiptsApplication().getFlex().getString(this, R.string.app_name));
	...
	/**
	 * @return - an instance of our {@link TripFragment} class.
	 * Allows for subclass flexibility
	 */
	...
	/**
	 * @return - an instance of our {@link ReceiptsListFragment} class.
	 * Allows for subclass flexibility
	 */
	...
	/**
	 * @return - an instance of our {@link ReceiptsChartFragment} class.
	 * Allows for subclass flexibility
	 */
