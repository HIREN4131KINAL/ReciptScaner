...
public class TableDefaultCustomizerImpl implements TableDefaultsCustomizer {
    ...
    public void insertPDFDefaults(@NonNull PDFTable pdfTable) {
        final ReceiptColumnDefinitions receiptColumnDefinitions = mReceiptColumnDefinitions;
    ...
    public void insertPaymentMethodDefaults(@NonNull PaymentMethodsTable paymentMethodsTable) {
        paymentMethodsTable.insert(new PaymentMethodBuilderFactory().setMethod(mContext.getString(R.string.payment_method_default_unspecified)).build());
        paymentMethodsTable.insert(new PaymentMethodBuilderFactory().setMethod(mContext.getString(R.string.payment_method_default_corporate_card)).build());
        paymentMethodsTable.insert(new PaymentMethodBuilderFactory().setMethod(mContext.getString(R.string.payment_method_default_personal_card)).build());
        paymentMethodsTable.insert(new PaymentMethodBuilderFactory().setMethod(mContext.getString(R.string.payment_method_default_cash)).build());
        paymentMethodsTable.insert(new PaymentMethodBuilderFactory().setMethod(mContext.getString(R.string.payment_method_default_check)).build());
    }
}
