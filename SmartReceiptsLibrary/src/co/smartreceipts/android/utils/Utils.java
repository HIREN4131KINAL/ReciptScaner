...
public class Utils {
	...
	public static void enableStrictMode() {
		if (ApiHelper.hasGingerbread()) {
			try {
				...
				// Just keep moving along if we get an exception
				// Robo-Electric does not place nice with strict mode
			}
		}
	}
	...
	/**
	 * This method converts dp unit to equivalent pixels, depending on device density. From:
	...
	/**
	 * This method converts device specific pixels to density independent pixels. From:
	 * http://stackoverflow.com/questions/4605527/converting-pixels-to-dp
	 * 
	 * @param px
