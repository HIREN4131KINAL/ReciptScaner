...
public class AppRating implements DialogInterface.OnClickListener, DialogInterface.OnCancelListener {
	...
	private static final class Keys {
		...
		/**
		 * Key to track what the current launch threshold is (this value is not static, since it may increase if the
		 * users wishes to be reminded later)
		 */
	...
	/**
	 * Nested interface to provide simple utilities for classes the require additional functionality via the
	 * {@link AppRating.Listener} interface.
	 */
	public interface Utilities {
		/**
		 * Call this method in order to launch the rating intent for the end user. In practice, this will open the
		 * Google Play Store (or equivalent)
		 */
...
//	}
	...
	/**
	 * @return - our internal instance of {@link SharedPreferences}. This may return null if we no longer have a valid
	 *         {@link Context}
	 */
