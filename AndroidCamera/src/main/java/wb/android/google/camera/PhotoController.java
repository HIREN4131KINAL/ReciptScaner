...
import wb.android.google.camera.ui.PieItem.OnClickListener;
...
public class PhotoController extends PieController
    ...
    public void initialize(PreferenceGroup group) {
        ...
        if (group.findPreference(CameraSettings.KEY_CAMERA_ID) != null) {
            PieItem item = makeItem(R.drawable.ic_smart_receipts);
        ...
        mOtherKeys = new String[] {
                ...
                CameraSettings.KEY_CAMERA_SMARTRECEIPTS_MAX_DIMENSION,
    ...
    protected void initializePopup() {
        ...
        MoreSettingPopup popup = (MoreSettingPopup) inflater.inflate(R.layout.more_setting_popup, null, false);
