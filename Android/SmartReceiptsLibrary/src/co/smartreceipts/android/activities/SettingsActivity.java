...
public class SettingsActivity extends PreferenceActivity implements OnPreferenceClickListener, UniversalPreferences {
	...
	/**
	 * Ugly hack to determine if a fragment header is currently showing or not.
	 * See if I can replace by counting the fragment manager entries
	 */
	...
	public boolean onPreferenceClick(Preference preference) {
		...
		if (key.equals(getString(R.string.pref_receipt_customize_categories_key)) ||
		...
		else if (key.equals(getString(R.string.pref_help_send_love_key))) { //Dark Pattern... Send Love => AppStore. Others for email
			...
			final Intent intent = EmailAssistant.getEmailDeveloperIntent(getString(R.string.feedback, getString(R.string.app_name)));
			startActivity(Intent.createChooser(intent, getResources().getString(R.string.send_email)));
			return true;
		}
		else if (key.equals(getString(R.string.pref_help_support_email_key))) {
			final Intent intent = EmailAssistant.getEmailDeveloperIntent(getString(R.string.support, getString(R.string.app_name)), getDebugScreen());
			startActivity(Intent.createChooser(intent, getResources().getString(R.string.send_email)));
			return true;
		}
		else {
