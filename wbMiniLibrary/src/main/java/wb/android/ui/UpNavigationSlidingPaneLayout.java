 ...
 * 
 * Modified this class from the Android support library implementation
 */
 ...
 */
public class UpNavigationSlidingPaneLayout extends ViewGroup {
	
    private static final String TAG = "UpNavigationSlidingPaneLayout";
    ...
    public UpNavigationSlidingPaneLayout(Context context) {
        this(context, null);
    }

    public UpNavigationSlidingPaneLayout(Context context, AttributeSet attrs) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(UpNavigationSlidingPaneLayout upNavigationSlidingPaneLayout, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(UpNavigationSlidingPaneLayout parent, View child) {
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == UpNavigationSlidingPaneLayout.this) {
